"""
Django settings for first_43487 project.
...
WSGI_APPLICATION = 'first_43487.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "first_43487 API",
    "DESCRIPTION": "API documentation for first_43487 App",
    "VERSION": "v1",
}
